...
INSERT INTO patrimonio_produtos (
    numero_patrimonio, nome_produto, descricao_produto, data_aquisicao, fornecedor,
    custo_aquisicao, localizacao, responsavel, valor_original, vida_util_estimada,
    status_atual, data_ultima_manutencao, proxima_manutencao_programada, fabricante
) VALUES (
    '$numero_patrimonio', '$nome_produto', '$descricao_produto', '$data_aquisicao', '$fornecedor',
    '$custo_aquisicao', '$localizacao', '$responsavel', '$valor_original', '$vida_util_estimada',
    '$status_atual', '$data_ultima_manutencao', '$proxima_manutencao_programada', '$fabricante'
